...
import { AccessKey } from '@mycore-test/js-common/access-key';
...
const emit = defineEmits<{
  (event: 'remove-access-key', accessKey: AccessKey): void;
...
const removeAccessKey = async (accessKey: AccessKey): Promise<void> => {
